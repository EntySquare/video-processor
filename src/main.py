...
def main():
    ...
    # 获取所有图片
    image_files = sorted(glob.glob(f"{args.image_dir}/*.jp*g"))
    if not image_files:
    ...
    if args.subtitle:
        ...
        subtitle_video = "temp_subtitle.mp4"
    ...
    # 清理临时文件
    for temp_file in ["temp_video.mp4", "temp_subtitle.mp4", "temp_audio.mp4"]:
